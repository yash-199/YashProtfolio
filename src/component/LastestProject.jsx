...
const LastestProject = () => {
    ...
    return (
        <div className='lg:w-[70rem] mx-auto text-white mt-20'>
            ...
            {/* Tab */}
            <div className='lg:w-[40rem] mx-auto lg:my-10 px-2'>
                {tab.map((tab) => (
                    <div
                        key={tab.id}
      ...
      ${activeTab === tab.id ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`}
                        ...
                        <div className="flex gap-10 items-start justify-between my-10">
                            <p className="lg:text-3xl text-4xl">{tab.id.toString().padStart(2, "0")}/</p>
                            ...
                            <BsArrowDownRightCircleFill
                                className={`lg:text-6xl text-5xl transition-transform duration-500 
        ${activeTab === tab.id ? "-rotate-90" : "rotate-0"}`}
            ...
            <div className='flex justify-center items-center lg:my-0 mt-10'>
